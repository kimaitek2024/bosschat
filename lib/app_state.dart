...
class FFAppState extends ChangeNotifier {
  ...
  Future initializePersistedState() async {
    ...
    await _safeInitAsync(() async {
      _expandMenu = await secureStorage.getBool('ff_expandMenu') ?? _expandMenu;
    });
  }
  ...
  set expandMenu(bool value) {
    _expandMenu = value;
    secureStorage.setBool('ff_expandMenu', value);
  }

  void deleteExpandMenu() {
    secureStorage.delete(key: 'ff_expandMenu');
  }

  DocumentReference? _activeChat =
      FirebaseFirestore.instance.doc('/conversations/hi');
